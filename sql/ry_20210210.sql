...
-- my sql scripts
-- 设备管理按钮
insert into sys_menu values('1062', '设备查询', '117', '1',  '#', '',  'F', '0', '1', 'system:device:list',        '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1063', '设备新增', '117', '2',  '#', '',  'F', '0', '1', 'system:device:add',         '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1064', '设备修改', '117', '3',  '#', '',  'F', '0', '1', 'system:device:edit',        '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1065', '设备删除', '117', '4',  '#', '',  'F', '0', '1', 'system:device:remove',      '#', 'admin', sysdate(), '', null, '');
...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_device values(100,  0,   '0',          '设备库',   0, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_device values(101,  100, '0,100',      '台式机', 1, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_device values(102,  100, '0,100',      '笔记本', 2, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_device values(103,  101, '0,100,101',  '主机',   1, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_device values(104,  101, '0,100,101',  '显示器',   2, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_device values(105,  101, '0,100,101',  '键盘',   3, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_device values(106,  101, '0,100,101',  '鼠标',   4, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_device values(107,  102, '0,100,102',  '电源',   1, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_device values(108,  102, '0,100,102',  '整机',   2, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', sysdate(), '', null);

-- 更新角色表 （增删改查权限，2是角色ID，角色权限分配）
